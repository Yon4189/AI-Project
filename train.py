...
if not os.path.exists(dataset_path):
    print(f"⚠️ Error: Dataset folder missing! Please place your images in: {dataset_path}")
...
# 4. Build Custom CNN Model Algorithm
print("⚙️ Building Convolutional Neural Network architecture...")
model = Sequential([
...
print("🗜️ Converting to compressed TFLite format for rapid web Server processing...")
